                ...
                <div className="team__info-wrap">
                    <div className="team__info-discord">
                        ...
                        <div className="team__info-discord-info">
                            ...
                            <h5 className="title"><Link href="https://discord.com/" target="_blank">50123</Link></h5>
                        </div>
                    </div>
                        ...
                        <ul className="list-wrap">
                            <li>
                                <div className="team__info-item">
                                    ...
                                    <div className="team__info-content">
                                        <span className="sub">Own the Hero</span>
                            ...
                            <li>
                                <div className="team__info-item">
                                    ...
                                    <div className="team__info-content">
                                        <span className="sub">Fight</span>
                                        <h5 className="title">165</h5>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div className="team__info-item">
                                    ...
                                    <div className="team__info-content">
                                        <span className="sub">Wins </span>
                                        <h5 className="title">48</h5>
                                    </div>
                                </div>
                            </li>
                        </ul>
