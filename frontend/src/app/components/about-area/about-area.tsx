  ...
  return (
    <li className="nav-item" role="presentation">
      ...
      >
        ...
        <Image src={img} alt="img" style={{width:"auto",height:"auto"}}/>
      </button>
    </li>
  );
}
          ...
          <div className="about__flex-wrap">
            <div className="about__content-wrap">
              <div className="about__content">
                ...
                <p>
                  Check out the latest heroes and nfts in the market.
                </p>
              </div>
              <div className="about__content-list">
                <ul className="list-wrap">
                  <li>
                    <Image src={icon_1} alt="img" /> Equipement Dragon Ball
                  </li>
                  <li>
                    <Image src={icon_2} alt="img" /> Space Babe Night
                  </li>
                  <li>
                    <Image src={icon_3} alt="img" /> Equipement #771
                  </li>
                </ul>
              </div>
            </div>
            <div className="about__btn-wrap">
              <ul className="list-wrap">
                <li>
                  <Link href="/shop">NFT Heroes Market</Link>
                </li>
                <li>
        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-7 col-md-10">
            <div className="section__title text-center mb-60">
              <TextAnimation title="Want to trade your heroes?" />
              <h3 className="title">Shop top rated heroes</h3>
            </div>
          </div>
        </div>
        <div className="row justify-content-center">
