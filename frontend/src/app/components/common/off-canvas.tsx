     ...
     <div className="offCanvas__wrap">
          <div className="offCanvas__body">
              ...
              <div className="offCanvas__content">
                  ...
                  <div className="offCanvas__contact">
                      ...
                      <ul className="offCanvas__contact-list list-wrap">
                          <li><Link href="tel:111">+1111111</Link></li>
                          <li><Link href="mailto:info@webmail.com">info@HSHGame.unkown</Link></li>
                      </ul>
                  </div>
              ...
              <div className="offCanvas__copyright">
                  <p>Copyright © {new Date().getFullYear()} - By <span>Art Crypto Sword Team for Solana Hackton 2024</span></p>
              </div>
          </div>
      </div>
