...
import slider_img from '@/assets/img/slider/5A.png';
                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-6">
                            <div className="slider__content">
                                <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">Solana Hackton 2025</h6>
                                <h2 className="title wow fadeInUp" data-wow-delay=".5s">5A Games </h2>
                                <p className="wow fadeInUp" data-wow-delay=".8s">Where all web3 games united. Battle Royale, Contract Heroes and more...</p>
                                <a href='/tournament'><p className="wow fadeInUp" data-wow-delay=".8s" style={{textAlign:'center', border:'1px dotted'}}>Play Now</p></a>
                        ...
                        <MouseParallaxChild factorX={0.03} factorY={0.03} className="slider__img text-center" >
                          <Image src={slider_img} alt="img" style={{height:'auto',marginTop:'7px'}} priority />
                        </MouseParallaxChild>
                        </div> 
                    </div>
                </div>
